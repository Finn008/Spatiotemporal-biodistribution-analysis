function [Out]=intrDrift_Fit(FitCoef,Xcenter,Ycenter,Zcenter,FfilenameTotal,RfilenameTotal,IntrDriftSettings)
global W;
...
while m>0
    ...
    ExcludeNumber=round((Upper+1-Lower)*IntrDriftSettings.ExcludeThreshold);
