function [Nuclei,Data3D,NucleiData]=dystrophyDetection_Nuclei(FilenameTotal,Readout,FilenameTotalOrig,ChannelListOrig)
timeTable('Start');
...
Threshold=prctile(Data3D(Outside==0),Settings{Readout,'PrctileCondensedChromatin'}{1}); % 80:2496, 85:2751, 90:3176, 95:4386, 98:7917, 99:11902
...
Threshold=prctile(Data3D(Outside==0),Settings{Readout,'Nuclei'}{1}); % 80:2496, 85:2751, 90:3176, 95:4386, 98:7917, 99:11902
...
% %     ex2Imaris_2(uint16(Wave2),Application,'Nuclei_Basins_Volume');
% %     
% %     Wave1=uint16(ceil(Table.DistanceMax));
% %     Wave1=Wave1(Basins(Basins>0));
% %     Wave2=Basins;
% %     Wave2(Basins>0)=Wave1;
% %     ex2Imaris_2(uint16(Wave2),Application,'Nuclei_Basins_DistanceMax');
...
% %     Wave1=uint16(ceil(Table.AreaXY));
% %     Wave1=Wave1(Basins(Basins>0));
% %     Wave2=Basins;
% %     Wave2(Basins>0)=Wave1;
% %     ex2Imaris_2(uint16(Wave2),Application,'Nuclei_Basins_AreaXY');
end
...
% Nuclei=im2Matlab_3(Application2,'Nuclei_FillRidgeLines');
...
if ShowIntermediateSteps==1
    ...
    Application2=openImaris_4(FilenameTotal,1,1);
%     ex2Imaris_2(Nuclei,Application2,'Nuclei_NucleiFinal');
    keyboard;
end
