...
while status==0
    ...
    inputemu('normal',pos.spacings);
    inputemu('key_normal','\TAB');
    inputemu('normal',pos.outside);
    inputemu('key_normal','\TAB');
    pause(1);
    inputemu('key_normal',ch1Wavelength);
    inputemu('key_normal','\TAB');
    pause(1);
    inputemu('normal',pos.outside);
    inputemu('key_normal','\TAB');
    pause(1);
    inputemu('key_normal',ch2Wavelength);
    inputemu('key_normal','\TAB');inputemu('key_normal','\TAB');
    pause(1);
    inputemu('key_normal','Multi-Photon Fluorescence');
    pause(1);
    clipboard('copy','W Plan-Apochromat 20x/1.0 DIC M27 75mm')
    inputemu('key_normal','\TAB'); inputemu('key_normal','\TAB');
    inputemu('key_down','\CTRL'); inputemu('key_normal','v'); inputemu('key_up','\CTRL');
    
    inputemu('normal',pos.immMedium);pause(1);inputemu('normal',pos.immMedium);pause(1);
    inputemu('key_down','\CTRL'); inputemu('key_normal','a'); inputemu('key_up','\CTRL');
    inputemu('key_normal','Water (1,333)');
    inputemu('key_normal','\TAB');inputemu('key_normal','\TAB');
    pause(1);
    inputemu('key_normal','Water (1,333)');
    inputemu('key_normal','\TAB');inputemu('key_normal','\TAB');
