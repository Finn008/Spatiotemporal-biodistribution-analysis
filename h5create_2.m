function h5create_2(Filename,Dataset,Size,varargin)
...
p.addParamValue('Datatype','double', ...
...
if isequal(options.Size,[98,47,4748])
    options.Datatype='None';
end
