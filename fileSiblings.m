function [Sibling,NameTable,ImageGroup]=fileSiblings(FilenameTotal)
...
% keyboard; % or if 4decon file already exists
[~,Report]=getPathRaw([OriginalFilename,'_4decon.ids']); % or if 4decon file already exists
if strcmp(FileType,'.lsm') && SizeOriginal<4 && Report==0
% if strcmp(FileType,'.lsm') && SizeOriginal<4.1
