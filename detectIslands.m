function [Data3D]=detectIslands(Mask,SizeMinMax,Res,Type,Border)
...
%     SizeMinMax(2,1:2)=3.1415*(SizeMinMax(1,1:2)/2).^2;
%     SizeMinMax(3,1:2)=4/3*3.1415*(SizeMinMax(1,1:2)/2).^3;
% end
if size(SizeMinMax,1)==1
...
%     Table=Table(Table.Area>SizeMinMax(2,1)&Table.Area<SizeMinMax(2,2),:);
...
% Wave1=zeros(Pix.','uint8');
% Wave1(cell2mat(Table.IdxList))=20;
% Data3D=Data3D+Wave1;
