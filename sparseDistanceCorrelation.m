function Table=sparseDistanceCorrelation(LinInd,Data3D,Res,ResCalc,MaxDistanceUm)
PixOrig=size(Data3D).';
Table=table;
Table.LinInd=LinInd;
...
% Wave1=interpolate3D_2(Data3D,Res,ResCalc,[],@max);
% A1=interpolate3D_2([1,2,3;4,5,6;7,8,9],Res,ResCalc,[],@max);
% Wave2=double(Data3D)-double(Wave1);
% Wave3=find(Wave2~=0);
