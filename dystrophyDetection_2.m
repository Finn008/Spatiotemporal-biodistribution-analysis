...
%     FctSpec.Nuclei=0; % not  working yet
    if FctSpec.Nuclei==1
        %         ShowIntermediateSteps=1;
        [Nuclei,DAPI,NucleiData]=dystrophyDetection_Nuclei_2(); % FilenameTotal,'DAPI',FilenameTotalOrig,ChannelListOrig
