function [PlaqueMap,DistanceFromBorder,Membership,PlaqueData,MetBlue,Output]=wholeSliceQuantification_PlaqueDetection_4(MetBlue,Outside,Res,FilenameTotal,Core2BackgroundRatio,CrudeDataVisualization)

if exist('CrudeDataVisualization','Var')==0 || CrudeDataVisualization==1
...
tic;
% [Data3D]=percentileFilter3D(Data3D,70,[27;27;3],Res,[20;20;Res(3)],Outside,1000); % 500µm
% [~,MetBlue]=sparseFilter(MetBlue,Outside,Res,10000,[100;100;1],[10;10;Res(3)],70,'Multiply1000');


% [MetBluePrc90,MetBlueCorr]=percentileFilter3D(MetBlue,90,[27;27;3],Res,[20;20;0.8],Outside,100); % 500µm
Window=[500;500;Res(3)];
if prod(Pix.*Res)>(1000*1000*50)
    ResCalc1=[8;8;Res(3)];
    [~,MetBlue]=percentileFilter3D_2(MetBlue,70,Res,ResCalc1,Outside,400,Window);
else
    ResCalc1=[8;8;Res(3)];
    [~,MetBlue]=sparseFilter_2(MetBlue,Outside,Res,10000,Window,ResCalc1,70,'Multiply400');
%     [~,MetBlue]=sparseFilter(MetBlue,Outside,Res,10000,[200;200;1],[10;10;Res(3)],Settings{Readout,'SpFiPrctile'}{1},Settings{Readout,'SpFiSubtrBackgr'}{1});
end
...
disp(['MetBluePrc70: ',num2str(toc/60),' min']);
...
% MetBlue=MetBlueCorr; clear MetBlueCorr;
