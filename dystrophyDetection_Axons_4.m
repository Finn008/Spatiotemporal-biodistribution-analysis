function [Data3D,DystrophyDiameter,Skeleton,AxonData]=dystrophyDetection_Axons_4()
timeTable('Start');
...
% if ShowIntermediateSteps==1; ex2Imaris_2(Axons,Application,'Test'); end;
...
[DystrophyMap,LocalMaxima,Wave1,BoutonTable]=watershedSegmentation_2(Axons,Version,Res,Data3D);
