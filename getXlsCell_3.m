% put out table or cell array
function [Out]=getXlsCell_3(Sheet,MyExcel,ColumnNames,Rows,TableOrCell)

if exist('TableOrCell','Var')==0 || TableOrCell==0
    Table=xlsActxGet(MyExcel,Sheet);
%     Columns=strfind1(Table.Properties.VariableNames.',ColumnNames);
    Columns=(1:size(Table,2)).';
    keyboard;
elseif TableOrCell==1
