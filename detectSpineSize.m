function detectSpineSize()
keyboard; % discontinued
global W;
FilenameTotal='Kaichuan_s1.CA1.1.so1.ims';
...
DendriteCenter=imdilate(DendriteCenter,ones(5,5,5));
...
SpineData=SpineData.*(1-DendriteCenter);
ex2Imaris_2(SpineData,Application,'SpineData');
