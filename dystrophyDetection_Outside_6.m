function [Outside,Output]=dystrophyDetection_Outside_6(FilenameTotal,DataBrainArea,FilenameTotalOrig,ChannelListOrig)
...
for Ch=1:size(ChannelInfo,1)
    ...
    Data3D=im2Matlab_3(FilenameTotalOrig,strfind1(ChannelListOrig,ChannelName,1));
...
Outside=dystrophyDetection_Outside_Global_2(ChannelInfo,Settings,ChannelName,ResCalc,FilenameTotal,PixOrig);
...
Path2file=getPathRaw([FilenameTotal,'_QualityControl_Outside@',ChannelName,'.tif']);
