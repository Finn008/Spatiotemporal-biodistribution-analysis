function [DystrophyData,DystrophyDiameter]=dystrophyDetection_DystrophyDetection_2(FctSpec)
timeTable('Start');
global ChannelTable;


Fileinfo=getFileinfo_2(ChannelTable{FctSpec.DystrophyChannelName,'SourceFilename'});
% [Fileinfo,Ind,PathRaw]=getFileinfo_2(FilenameTotal);
Res=Fileinfo.Res{1};

% [Outside]=im2Matlab_3(FilenameTotal,'Outside');
[DystrophyData]=im2Matlab_3(ChannelTable{FctSpec.DystrophyChannelName,'SourceFilename'},ChannelTable{FctSpec.DystrophyChannelName,'SourceChannelName'});
% [DystrophyData]=im2Matlab_3(ChannelTable{NucleiChannelName,'SourceFilename'},ChannelTable{NucleiChannelName,'SourceChannelName'});
try
...
[DystrophyData,DystrophyDiameter]=dystrophyDetection_IndividualDystros_3(DystrophyData,Outside,Res,Settings(FctSpec.DystrophyChannelName,:));
...
ChannelInfo.Res(:,1)={[]};
Path2file=getPathRaw([ChannelTable{FctSpec.DystrophyChannelName,'TargetFilename'}{1},'_QualityControl_',FctSpec.DystrophyChannelName,'Dystrophy.tif']);
