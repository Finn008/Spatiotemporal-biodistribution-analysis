function [Data3D,AxonDiameter]=dystrophyDetection_Axons_2()
timeTable('Start');
...
Data3D(Outside==1)=0;
if ShowIntermediateSteps==1; ex2Imaris_2(Data3D,Application,'Axons_PercentileFilter',1,Res); end
...
% % imarisSaveHDFlock(ChannelTable.TargetFilename{'ShowIntermediate'}{1});
global Application; Application=openImaris_4(ChannelTable.TargetFilename{'ShowIntermediate'},[],1,1);
% Version=struct('DistanceTransformation',1,'WatershedUmBin',WatershedUmBin);
tubeDetection(logical(WatershedDistance),Res);
