function [Table]=processTraceGroups_4(MouseInfo,PlaqueListSingle,DataArray,DataType,RadiiBinning,TimeBinning)
global W;
...
DataArray=fuseTable_MatchingColums_4(DataArray,PlaqueListSingle,{'Filename';'MouseId';'Membership'},{'BorderTouch'});
DataArray(DataArray.BorderTouch==1,:)=[];

% if exist('ThresholdDistanceCenter2Border')==1
%     DataArray(DataArray.BorderTouch==1 & min(DataArray.DistanceCenter2TopBottom,[],2)<ThresholdDistance2Border,:)=[];
% else
%     DataArray(DataArray.BorderTouch==1,:)=[];
% end
