function [Outside]=dystrophyDetection_Outside_2(FilenameTotal,Application,DataBrainArea)
...
%     [Outside]=dystrophyDetection_Outside_MetBlue(MetBlue,Res);
...
Window2(Window2<3)=3;
Outside=imerode(Outside,ones(Window2.')); % Outside 2
